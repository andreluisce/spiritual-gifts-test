...
COMMENT ON FUNCTION public.get_user_quiz_results IS 'Returns all quiz results for a specific user (manager/admin only) - handles empty cases gracefully, returns Portuguese gift names';
