-- Fix get_quiz_report by removing dependency on non-existent gift_content table
-- Provide default AI insights instead
...
BEGIN
    ...
    SELECT json_build_object(
        ...
        'ai_insights', '[]'::json  -- Return empty array since gift_content table doesn't exist
    ) INTO report_data;
...
COMMENT ON FUNCTION public.get_quiz_report IS 'Returns comprehensive quiz report without gift_content dependency';
