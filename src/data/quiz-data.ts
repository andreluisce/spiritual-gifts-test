...
/**
 * Get spiritual gifts with localized names
 */
export function getSpiritualGifts(locale: string = 'pt'): SpiritualGift[] {
  return [
    {
      key: 'A_PROPHECY',
      name: getGiftNameStatic('A_PROPHECY', locale),
    ...
    {
      key: 'B_SERVICE',
      name: getGiftNameStatic('B_SERVICE', locale),
    ...
    {
      key: 'C_TEACHING',
      name: getGiftNameStatic('C_TEACHING', locale),
    ...
    {
      key: 'D_EXHORTATION',
      name: getGiftNameStatic('D_EXHORTATION', locale),
    ...
    {
      key: 'E_GIVING',
      name: getGiftNameStatic('E_GIVING', locale),
    ...
    {
      key: 'F_LEADERSHIP',
      name: getGiftNameStatic('F_LEADERSHIP', locale),
    ...
    {
      key: 'G_MERCY',
      name: getGiftNameStatic('G_MERCY', locale),
...
// Keep the original export for backward compatibility (Portuguese names)
