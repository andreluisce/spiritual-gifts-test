      ...
      {insights.dominantPattern && (
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            {hasAIAnalysis && compatibilities[0]?.aiEnhancedAnalysis?.ministryRecommendations?.length > 0 && (
            ...
            {/* Aplicações Práticas */}
            {hasAIAnalysis && compatibilities[0]?.aiEnhancedAnalysis?.practicalApplications?.length > 0 && (
              ...
              <div key={index} className="border rounded-lg p-4">
                ...
                <div className="flex items-center justify-between text-xs text-gray-500">
                  <div className="flex items-center gap-4">
                    <span>
                      <strong>{t('essentialGifts')}:</strong> {ministry.requiredGifts.map(g => getGiftName(g)).join(', ')}
                    </span>
                  </div>
