...
import { CountrySelect, resolveCountryLabel } from '@/components/CountrySelect'
...
export default function ProfilePage() {
  ...
  const handleSaveProfile = async (data: ProfileEditForm) => {
    try {
      ...
      // Preserve existing age range until it is derived automatically from birth date
                ...
                <form onSubmit={handleSubmit(handleSaveProfile)} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      {!isEditing ? (
                        <Input
                          value={resolveCountryLabel(profile?.country) || t('notProvided')}
                          disabled
                          className="bg-gray-50"
                        />
                      ) : (
